...
public class EarthQuakeInfoWindow extends JFrame {
    ...
    public EarthQuakeInfoWindow(int index) throws IOException {
        ...
        String url = "https://restapi.amap.com/v3/staticmap?location=" + json.getString("longitude") + "," + json.getString("latitude") + "&zoom=8&size=400*200&markers=mid,,A:" + json.getString("longitude") + "," + json.getString("latitude") + "&key=";
